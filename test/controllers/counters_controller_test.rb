...
class CountersControllerTest < ActionController::TestCase
  ...
  test "should create counter" do
    assert_difference('Counter.count') do
      post :create, counter: { count: @counter.count, first_name: @counter.first_name, last_name: @counter.last_name }
    end
  ...
  test "should update counter" do
    patch :update, id: @counter, counter: { count: @counter.count, first_name: @counter.first_name, last_name: @counter.last_name }
    assert_redirected_to counter_path(assigns(:counter))
  end
